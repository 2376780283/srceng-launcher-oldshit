package com.zzh.widget.progressbar;
...
public class ProgressBarRoundNormal extends View {
    ...
    public ProgressBarRoundNormal(Context context) {
        this(context, null);
    }
    public ProgressBarRoundNormal(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ProgressBarRoundNormal(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(calcProgressFromSweepAngle(mSweepAngle) + getContext().getString(R.string.srceng_launcher_Achievement), xPos, yPos, mPaint);
    }

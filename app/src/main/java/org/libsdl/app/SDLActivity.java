...
public class SDLActivity extends AppCompatActivity
    ...
    SharedPreferences sharedPreferences_mouse;
    private View ImprovemView;
    private static final String SWITCH_STATE_M = "switch_state_m";
    ...
    public static native void nativeSetScreenResolution(
            int surfaceWidth, int surfaceHeight, int deviceWidth, int deviceHeight, float rate);
    ...
    public static boolean isScreenKeyboardShown() {
        ...
        InputMethodManager imm =
                (InputMethodManager)
                        SDL.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void saveElapsedTime() {
        ...
        editor.putLong(KEY_TOTAL_TIME, accumulatedTime);
        editor.apply();
    }
    ...
    public static double getDiagonal() {
        ...
        // 将xDPI和yDPI放大2倍
        double dWidthInches = metrics.widthPixels / (double) (metrics.xdpi * 0.2);
        double dHeightInches = metrics.heightPixels / (double) (metrics.ydpi * 02);
...
class SDLSurface extends SurfaceView
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getSource() == InputDevice.SOURCE_MOUSE
            ...
            // We need to check if we're in relative mouse mode and get the axis offset rather than
            // the x/y values
                ...
                case MotionEvent.ACTION_CANCEL:
                    for (i = 0; i < pointerCount; i++) {
                        ...
                        SDLActivity.onNativeTouch(
                                touchDevId, pointerFingerId, MotionEvent.ACTION_UP, x, y, p);
                    }
                    break;

package zzh.source.csso;

import androidx.viewpager.widget.ViewPager;
import zzh.source.csso.databinding.ActivityMainBinding;
...
import com.zzh.widget.tablayout.VerticalTabLayout;
import com.zzh.widget.tablayout.VerticalTabLayoutMediator;
import androidx.viewpager2.widget.ViewPager2;
import com.valvesoftware.ValveActivity2;
import zzh.util.PagerAdapter;
import zzh.util.CrashReportActivity;
...
import zzh.util.DirectorySizeCalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String VALID_SIGNATURE =
            "18F805905AC4A5327A8D1CA046D5E93D6A3F1160122BD79B8A8C1D3E1666F964";
    ...
    private void updateDirectorySizeUI() {
        long directorySize =
                sizeCalculator.calculateDirectorySize(
    ...
    */
    ...
    protected void onDestroy() {
        ...
        SharedPreferences.Editor editor =
                getSharedPreferences("last_launch_time", Context.MODE_PRIVATE).edit();
    ...
    private void saveCrashLog(String log) {
        try (FileOutputStream fos =
                new FileOutputStream(new File(getFilesDir(), "crash_log.txt"))) {
    ...
    private void showSignatureErrorDialog() {
        ...
        AlertDialog dialog =
                new AlertDialog.Builder(this).setView(dialogView).setCancelable(false).create();

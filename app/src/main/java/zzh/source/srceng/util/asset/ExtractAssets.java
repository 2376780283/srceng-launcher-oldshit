package zzh.source.srceng.util.asset;
...
public class ExtractAssets {
  ...
  public static final String VPK_NAME = "include.vpk";
    ...
    try {
      Log.d(
          ...
          "chmod "
              ...
              + ": "
              + Runtime.getRuntime()
                  .exec("chmod " + Integer.toOctalString(mode) + " " + path)
                  .waitFor());
    } catch (Exception e) {
      ...
      return ((Integer)
              Class.forName("android.os.FileUtils")
                  ...
                  .invoke(
                      null,
                      new Object[] {
                        path, Integer.valueOf(mode), Integer.valueOf(-1), Integer.valueOf(-1)
                      }))
          .intValue();
    } catch (Exception e2) {
  ...
  public static void extractVPK(Context context, Boolean force) {
    ...
    try {
      ...
      if (mPref.getInt("pakversion", 0) == PAK_VERSION && !force) return;
